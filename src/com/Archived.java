...
//		String outputFilePath = "C:\\savencia\\Output\\38PROD_may6.xml";
		String outputFilePath = "C:\\savencia\\Output\\polyTestingfile.xml";
...
//							Element  servingSizeId= doc.createElement("EntityCrossReference");
			...
			if (packagingID != null) {				
				...
				pkeyvalue.setTextContent(packagingID);
					...
					pkeyvalue.setTextContent("SP"+productId.substring(2));	
				}
